// src/components/WhatsAppButton.jsx — Botón flotante WhatsApp Business
  ...
  return (
    ...
    >
      ...
      <div className="relative w-14 h-14 flex items-center justify-center">
        ...
        <div className="relative w-14 h-14 rounded-full bg-green-500 hover:bg-green-600 shadow-lg shadow-green-500/30 flex items-center justify-center transition-transform duration-200 hover:scale-110">
